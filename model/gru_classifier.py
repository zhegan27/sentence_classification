...
from gru_layers import param_init_encoder, encoder
...
def build_model(tparams,options):
    ...
    h_encoder = encoder(tparams, emb, mask=mask, prefix='gru_encoder')
    h_encoder_rev = encoder(tparams, emb[::-1], mask=mask[::-1], prefix='gru_encoder_rev')
